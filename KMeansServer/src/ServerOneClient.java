...
/**
 * La classe ServerOneClient implementa l'interfaccia Runnable la
 * quale la rende in grado di poter essere eseguita essa stessa
 * come un thread,in questa vengono gestite la richiesta
 * di lettura e scoperta di cluster
 * 
