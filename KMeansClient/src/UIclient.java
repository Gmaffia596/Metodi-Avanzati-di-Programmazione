...
public class UIclient {
	...
	/**
	 * 
	 * Questa classe nota come UIClient (abbreviazione di "user interface client") inizializza
	 * i componenti dell'interfaccia grafica del client le le loro funzionalità,nonchè disposizioni
	 * all'interno del frame principale
	 * 
	 */
